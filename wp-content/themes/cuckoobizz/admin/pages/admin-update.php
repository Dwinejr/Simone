...
*/
	...
	<section id="main_content">
		<?php cuckoo_framework_head( __('Theme Updates', 'cuckoothemes') ); ?>
		<div id="general_settings">
			...
			if( $xml = cuckoo_theme_changelog() ) {
				...
				if( version_compare( $theme_version, $xml->latest ) == -1 ){
					...
					<div class="general_title_active">
						<span class="float_left"><?php _e('New Theme Update' , 'cuckoothemes'); ?></span>
					...
					?>
					<div class="general_title_active">
						<span class="float_left"><?php _e('Latest Version' , 'cuckoothemes'); ?></span>
					</div>
				...
				<div class="general_title_active">
						<span class="float_left"><?php _e('Changelog' , 'cuckoothemes'); ?></span>
				</div>
				<div class="active_settings" style="display: block;">
			...
			?> 
			<div class="general_title_active">
				<span class="float_left"><?php _e('Not Connection!' , 'cuckoothemes'); ?></span>
			</div>
			<div class="active_settings" style="display: block;">
					<div class="section_settings" style="border:none; text-align:center;">
					<?php _e( '<p>Error: Unable to fetch the changelog.</p>', 'cuckoothemes' ); ?>

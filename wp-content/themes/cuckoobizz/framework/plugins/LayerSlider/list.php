...
<?php } ?>
<div class="info_slider_not_update_cuckoo" style="display:block; margin-right:15px;">IMPORTANT! FOR CUCKOOTHEMES CUSTOMERS WHO'VE PURCHASED LAYERSLIDER SLIDER WITH THE THEME.<br />We do not update LayerSlider slider at once when new slider update is released. We always wait for a stable and tested version of LayerSlider slider, because we don't want you to have any issues with it. At the moment slider is fully functional and works without any issues. Do not try update LayerSlider slider yourself because slider files should be integrated within the theme, it won't work if you simply overwrite existing slider files. Please be patient and when stable version will be confirmed - we'll update it immediately.</div>	

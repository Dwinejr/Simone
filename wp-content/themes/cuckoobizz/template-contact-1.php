...
*
*
** Template Name: Contact Page Template 1
*/
	...
	<?php if(isset($slider[1]) != 1) : get_template_part( 'loop/total/template-header' ); endif; ?>
		...
		<section id="contact" class="clearfix">
			...
			<?php else : ?>
				...
				<?php echo '<iframe class="map-baqckground" src="http://maps.google.com/maps?f=q&amp;source=s_q&amp;iwloc=yes&amp;hl=en&amp;q='.$gPropert.'&amp;z='.$cuckoo_contact['google_zoom_level'].'&amp;ie=UTF8&amp;t=m&amp;output=embed"></iframe>' ?>
			<?php endif; ?>
			<article class="contact-content screen-large map-on">
			...
			<div class="show-map"><?php _e('Map On', 'cuckoothemes'); ?></div>
			<div id="result"></div>
		</section>
	</section>
<?php get_footer(); ?>